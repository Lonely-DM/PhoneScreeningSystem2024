...
class CalendarWithSidebar extends Component {
  ...
  componentDidMount() {
    // Dynamically add Material Icons link
  ...
  setNewAppointment = () => {
    ...
    if (start && end && title) {
      let appointment = {
        ...
        desc,
        color, // Add the selected color to the event object
        id: moment().valueOf(),
      };
      this.setState((prevState) => ({
        ...
        color: "#3174ad", // Reset the color to default
      }));
    }
  };
        ...
        {colors.map((c) => (
          <div
            ...
            style={{
              ...
              width: "25px", // Ensure uniform size
              height: "25px",
              borderRadius: "50%",
              cursor: "pointer",
              margin: "0 10px",
              border: this.state.color === c.color ? "2px solid black" : "2px solid transparent",
            }}
          />
        ))}
      </div>
      ...
      <LocalizationProvider dateAdapter={AdapterMoment}>
        <div className="calendar-page">
          <div className="main-container">
            {/* Navigation Sidebar */}
            <aside id="sidebar" className="navigation-sidebar">
          ...
          >
            ...
            <div style={{ marginTop: 20 }}>
              ...
              {this.renderColorPicker()} {/* Color picker added here */}
            </div>
